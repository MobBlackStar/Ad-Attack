...
class HomeController extends Controller {
    ...
    public function index() {
        ...
        $briefModel = new \App\Models\Brief();
        ...
        $this->view('home',[
            'title' => 'Ad-Attack | The Apex',
            'topAgencies' => $hallOfFame,
            // Pass live stats to the terminal
            'totalBriefs' => count($briefModel->findAll()),
            'totalAds' => count($adModel->findAll())
        ]);
    }
}