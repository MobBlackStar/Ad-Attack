        ...
        <div class="row">
            ...
            <div class="col-md-7 mb-4">
                <div class="card bg-secondary border-0 shadow-lg">
                    ...
                    <!-- FEDI & SARRA MERGE: Smart Display Logic -->
                    <!-- We check if there is an image. If not, we check for an External Link. -->
                    <?php if(!empty($ad->image_path)): ?>
                        <!-- TEAM: basename() pour éviter les problèmes de chemin d'accès -->
                    ...
                    <?php elseif(!empty($ad->external_link)): ?>
                        <!-- ARCHITECT FIX: If it's a link (like YouTube/Dribbble), show a special button! -->
                    ...
                    <div class="card-body p-4 bg-dark">
                        ...
                        <p class="text-info font-monospace small">Exhibited by: <strong class="text-white"><?= htmlspecialchars($ad->agency_name ?? 'Agency #'.$ad->agency_id) ?></strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content bg-dark text-white border-danger shadow-lg" style="box-shadow: 0 0 20px rgba(255, 0, 60, 0.5);">
                                        ...
                                        <div class="modal-body text-center p-4">
                                            <p class="fs-5">Team: Are you sure you want to permanently shred this campaign?</p>
