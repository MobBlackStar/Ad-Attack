...
<div class="d-flex justify-content-between align-items-center mb-5">
    ...
    <a href="<?= BASE_URL ?>/brief/create" class="btn btn-warning shadow">+ Post New Brief</a>
</div>
        ...
        <?php foreach($briefs as $brief): ?>
            <div class="col-md-4 mb-4">
                <div class="card bg-secondary h-100 border-0 shadow-lg">
                    <!-- We point to our physical uploads folder using BASE_URL -->
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="<?= BASE_URL ?>/brief/show/<?= $brief->id ?>" class="btn btn-outline-warning mt-auto w-100">View & Submit Ad</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
